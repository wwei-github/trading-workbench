...
10. 止损锚定（2026-09-13 更新：关键位优先，极值兜底；程序按此规则直接定锚，stop 值仅参考）：
    做多优先锚定入场价下方最近支撑位的区域下轨（zone_low）外 0.2%~0.5%，做空锚定上方最近压力位的区域
    上轨（zone_high）外同幅度，锚须落在最近 10 根K线影线范围内；该范围内无同类关键位时用极值锚——
    做多严格低于最近 10 根K线最低点（影线极值非收盘价）至少 0.2%，做空相反。
