...
- take_profit_1: 第一档止盈价，必须锚定入场方向前方的关键位（做多=上方的压力位，做空=下方的支撑位）并留余地，盈亏比≥1.5。skip 时为 0。
- take_profit_2: 第二档止盈价，锚定更前方一档的关键位（做多=更高一档压力位、做空=更低一档支撑位）且必须比止盈一更远，盈亏比≥3。skip 时为 0。
...
- 止盈一：必须是入场方向前方的关键位——做多锚定上方的压力位，做空锚定下方的支撑位，
  并留一点余地（做多比该位低 0.2%~0.5% 提前止盈，做空相反）；若到最近关键位的盈亏比不足 1.5，
  取下一档更远的关键位作止盈一。盈亏比 ≥1.5 是开单硬性要求。
- 止盈二：取更前方一档的关键位（做多=更高一档压力位，做空=更低一档支撑位），同样留余地；止盈二必须比止盈一更远。
