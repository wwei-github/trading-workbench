...
- 优先：做多锚定入场价下方最近支撑位价格线外 0.3%（建议 0.3%~0.5%），做空锚定入场价上方最近压力位价格线外同幅度；锚须落在最近 5 根K线影线范围内（即"5根之内有关键位"）。
- 两锚取更远者：入场贴着关键位是区间边缘类开单的常态，此时线位在 5 根影线范围内，只锚关键位会把止损放进近期波动区间内部、极易被扫损。止损必须同时在关键位外与影线极值外——做多取支撑线与最近 5 根最低点中更低者外 0.3%，做空取压力线与最近 5 根最高点中更高者外 0.3%。
- 兜底：入场价与最近 5 根影线极值之间没有任何同类关键位时，用极值锚——做多严格低于最近 5 根最低点（影线极值即最低价，非收盘价）至少 0.3%，做空严格高于最高点至少 0.3%。
